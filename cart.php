...
<section class="shopping-cart">
   ...
   <form action="" method="post">
      <input type="text" min="1" name="coupon_code" value="<?php echo isset($_POST['coupon_code']) ? $_POST['coupon_code'] : ''; ?>" style="border: 5px solid #ccc; padding: 5px;">
      <input type="submit" name="apply_coupon" value="apply" class="option-btn">
   </form>
   <?php
      if(isset($message)){
         if(is_array($message)) { // Add this condition to check if $message is an array
