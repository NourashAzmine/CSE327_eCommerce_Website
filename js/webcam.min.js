...
/* Took help from these following github link:

 WebcamJS v1.0.25 - http://github.com/jhuckaby/webcamjs - MIT Licensed

The webcam.min.js library is used to capture images or videos from a webcam using JavaScript. 

In our project I am using it so that user can take picture to add to the complaint box via webcam. */
