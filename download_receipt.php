...
if(isset($_GET['order_id'])) {
    ...
    $pdf->Cell(0, 10, ($fetch_order['total_price'] - $fetch_order['discount_total_price']).'/-'." Taka", 0, 1);
    $pdf->Cell(50, 10, 'Subtotal:', 0, 0);
    $pdf->Cell(0, 10, $fetch_order['discount_total_price'].'/-'." Taka", 0, 1);

    // Footer - Thank You Statement
    $pdf->Cell(0, 10, '', 0, 1); // Empty line for spacing
    $pdf->Cell(0, 10, '', 0, 1); // Empty line for spacing
    $pdf->Cell(0, 10, '', 0, 1); // Empty line for spacing
